...
| Crédits et abonnements | Version web : portefeuille par appareil (D1), 100 crédits offerts par mois, facturation au token réel sur chaque requête IA, analyse de lien et transcription ; formules Gratuit, Créateur, Pro et Équipe, en mensuel ou annuel ; packs ; limites par jour et par modèle ; Stripe Checkout, portail client, webhook signé et idempotent ; historique des consommations. Dans claude.ai : l'IA utilise le compte Claude, rien n'est facturé. Mobile Money et comptes Supabase : à venir |
